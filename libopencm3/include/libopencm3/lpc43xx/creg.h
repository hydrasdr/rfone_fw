...
@author @htmlonly &copy; @endhtmlonly 2014-2024 Benjamin Vernoux <bvernoux@hydrasdr.com>
 ...
 * Copyright (C) 2014-2024 Benjamin Vernoux <bvernoux@hydrasdr.com>
 *
...
/* ARM Cortex-M0s memory mapping */
#define CREG_M0SUBMEMMAP                MMIO32(CREG_BASE + 0x308)

/* Cortex-M0s TXEV event clear */
#define CREG_M0SUBTXEVENT               MMIO32(CREG_BASE + 0x314)
...
/* --- CREG_M0SUBTXEVENT values ------------------------------------ */

/* TXEVCLR: Cortex-M0s TXEV event */
#define CREG_M0SUBTXEVENT_TXEVCLR_SHIFT (0)
#define CREG_M0SUBTXEVENT_TXEVCLR (1 << CREG_M0SUBTXEVENT_TXEVCLR_SHIFT)

/* --- CREG_M0SUBMEMMAP values ---------------------------------- */

/* M0SUBMAP: Shadow address when accessing memory at address 0x00000000 */
#define CREG_M0SUBMEMMAP_M0SUBMAP_SHIFT (12)
#define CREG_M0SUBMEMMAP_M0SUBMAP_MASK \
			(0xfffff << CREG_M0SUBMEMMAP_M0SUBMAP_SHIFT)
#define CREG_M0SUBMEMMAP_M0SUBMAP(x) ((x) << CREG_M0SUBMEMMAP_M0SUBMAP_SHIFT)
