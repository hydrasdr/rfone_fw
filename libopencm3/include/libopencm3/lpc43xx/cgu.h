 ...
 * <mike@ossmann.com>
 * Benjamin Vernoux <bvernoux@hydrasdr.com>
 *
...
#define CGU_BASE_ADCHS_CLK              MMIO32(CGU_BASE + 0x08C)
...
/* --- CGU_BASE_ADCHS_CLK values --------------------------------- */

/* PD: Output stage power down */
#define CGU_BASE_ADCHS_CLK_PD_SHIFT	(0)
#define CGU_BASE_ADCHS_CLK_PD		(1 << CGU_BASE_ADCHS_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_ADCHS_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_ADCHS_CLK_AUTOBLOCK	(1 << CGU_BASE_ADCHS_CLK_AUTOBLOCK_SHIFT)

/* CLK_SEL: Clock source selection */
#define CGU_BASE_ADCHS_CLK_CLK_SEL_SHIFT (24)
#define CGU_BASE_ADCHS_CLK_CLK_SEL_MASK \
			(0x1f << CGU_BASE_ADCHS_CLK_CLK_SEL_SHIFT)
#define CGU_BASE_ADCHS_CLK_CLK_SEL(x)	((x) << CGU_BASE_ADCHS_CLK_CLK_SEL_SHIFT)
