...
/* M0_SUB_RST: Writing a one activates the reset */
#define RESET_CTRL0_M0_SUB_RST_SHIFT (12)
#define RESET_CTRL0_M0_SUB_RST (1 << RESET_CTRL0_M0_SUB_RST_SHIFT)
...
/* ADCHS_RST: Writing a one activates the reset */
#define RESET_CTRL1_ADCHS_RST_SHIFT (60)
#define RESET_CTRL1_ADCHS_RST (1 << RESET_CTRL1_ADCHS_RST_SHIFT)
